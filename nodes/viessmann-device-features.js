    ...
    function ViessmannDeviceFeaturesNode(config) {
        ...
        node.on('input', async function(msg) {
            ...
            try {
                ...
                // Fetch features from Viessmann API
                const response = await axios.get(`${node.apiBaseUrl}/iot/v2/equipment/installations/${installationId}/gateways/${gatewaySerial}/devices/${deviceId}/features`, {
                    headers: {
                ...
                node.error('Failed to fetch device features: ' + errorMsg, msg);
            }
        });
    }
